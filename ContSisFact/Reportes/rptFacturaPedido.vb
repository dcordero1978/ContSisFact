...
Public Class rptFacturaPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ContSisFact.rptFacturaPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaPedido = New rptFacturaPedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
